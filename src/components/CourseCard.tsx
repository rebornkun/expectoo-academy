const CourseCard = ({
  ...
  return (
    <div className="bg-white border-[0.5px] border-[#00000040] rounded-[16px] px-[1rem] py-[2.5rem] flex flex-col gap-4 items-center justify-center w-[250px] flex-1 min-w-[250px] max-w-[300px] ">
      {svg}
